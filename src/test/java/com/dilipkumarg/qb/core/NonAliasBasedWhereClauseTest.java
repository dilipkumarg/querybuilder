...
public class NonAliasBasedWhereClauseTest {
    private NonAliasBasedWhereClause builder;
    private QPerson person = new QPerson("p");

    @Before
    public void setUp() throws Exception {
        builder = new NonAliasBasedWhereClause();
    }
    ...
    public void testGetWhereCondition() throws Exception {
        ...
        assertEquals(condition.buildConditionWithoutAlias(), builder.getWhereCondition(condition));
    }
}